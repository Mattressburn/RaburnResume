...
export default function BootSequence({ onComplete }) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-cyan-400 font-mono p-8 flex flex-col justify-end pb-32">
            <div className="max-w-2xl mx-auto w-full">
                ...
                <div className="animate-pulse mt-4 text-cyan-400">_</div>
            </div>
        </div>
    );
}